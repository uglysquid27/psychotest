  ...
  return (
    <AuthenticatedLayout header={<h2 className="text-xl font-semibold">Tes Deret Angka</h2>}>
      <div className="max-w-6xl mx-auto p-4 md:p-6">
        ...
        {isSubmitted && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mt-6 animate-fade-in">
        ...
        {timeLeft>0 && timeLeft<=60 && !isSubmitted && (
