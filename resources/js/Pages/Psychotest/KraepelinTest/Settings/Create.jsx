// resources/js/Pages/Psychotest/KraepelinTest/Settings/Create.jsx

import { useState } from 'react';
import { Head, router, usePage } from '@inertiajs/react';
import AuthenticatedLayout from '@/Layouts/AuthenticatedLayout';

export default function CreateKraepelinSetting({ difficultyOptions }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.post(route('admin.kraepelin.settings.store'), form);
    };
    ...
    return (
            ...
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">
                        Tambah Pengaturan Tes Kraepelin
                    </h2>
                    <button
        ...
        >
            <Head title="Tambah Pengaturan Tes Kraepelin" />
                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            ...
                            <div className="mb-8">
                                <h3 className="text-lg font-medium text-gray-900 mb-4">Konfigurasi Cepat:</h3>
                                    ...
                                    {presetConfigs.map((preset, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="text-xs text-gray-500 mt-1">
                                                {(preset.rows - 1) * preset.columns} soal
                                            </div>
                                        </button>
                                    ))}
                                </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            required
                                            placeholder="Contoh: Tes Kraepelin Standar"
                                        />
                                        {errors.name && (
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            className="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                            rows="2"
                                            placeholder="Tambahkan deskripsi pengaturan (opsional)"
                                        />
                                        {errors.description && (
