        ...
        <div className="bg-white dark:bg-gray-800 shadow-md mb-4 p-4 sm:p-6 rounded-lg">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-3">
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base">
                        {selectedIds.length} dari {request.requested_amount}{" "}
                        karyawan terpilih
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                {selectedIds.map((id, index) => {
                    ...
                    const isAssigned =
                        emp.status === "assigned" && !emp.isCurrentlyScheduled;
                    ...
                    const lineAssignment = lineAssignments[id];
                    ...
                    return (
                        ...
                        >
                            {/* Line Assignment Badge */}
                           {(isPutwaySubsection || isShrinkSubsection) && lineAssignment && (
    <div className="absolute top-2 left-2 z-10">
        <span className={`text-xs px-2 py-1 rounded ${
            ...
            {lineAssignment.label}
                            ...
                            <div
                                className={`absolute ${
                                    isPutwaySubsection || isShrinkSubsection
                                        ? "top-12"
                                        : "top-2"
                            ...
                            <button
                                type="button"
                                onClick={() =>
                                    !isAssigned && openChangeModal(index)
                                }
                                disabled={isAssigned}
                ...
                {Array.from({
                    length: Math.max(
                        0,
                        request.requested_amount - selectedIds.length
                    ),
                }).map((_, index) => (
                    <motion.div
                        key={`empty-${index}`}
                        ...
                        transition={{
                            duration: 0.3,
                            delay: (selectedIds.length + index) * 0.1,
                        }}
                ...
                >
                    <div className="flex items-center">
                        ...
                        <p className="text-yellow-700 dark:text-yellow-300 text-sm">
                            Beberapa karyawan yang dipilih sudah ditugaskan di
                            request lain. Mereka mungkin tidak tersedia.
                        </p>
                    </div>
                </motion.div>
            )}
